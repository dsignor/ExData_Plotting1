...
legend("topright", xjust = 1,yjust=0,col = c("black", "red","blue"),cex=.85,
       x.intersp = .25, y.intersp = .75,legend = c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),lwd=c(1.5,1.5,1.5))
